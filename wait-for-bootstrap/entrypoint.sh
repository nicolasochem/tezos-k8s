...
FIRST_BOOTSTRAP_NODE="tezos-bootstrap-node-0.tezos-bootstrap-node-rpc"
...
until nc -q 0 tezos-bootstrap-node-0.tezos-bootstrap-node-rpc 8732; do echo "waiting for bootstrap node to accept connections"; sleep 2; done;
